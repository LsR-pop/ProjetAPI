...
const raw = readFileSync("JSON-to-MySQL/data/que-faire-a-paris.json");
...
AccessType.hasMany(Event, { foreignKey: "accessType_id" });
Event.belongsTo(AccessType, { foreignKey: "accessType_id" });

// Définition des relations many-to-one entre Event et PriceType
PriceType.hasMany(Event, { foreignKey: "priceType_id" });
Event.belongsTo(PriceType, { foreignKey: "priceType_id" });

// Définition des relations many-to-one entre Event et Audience
Audience.hasMany(Event, { foreignKey: "audience_id" });
Event.belongsTo(Audience, { foreignKey: "audience_id" });
...
Address.hasMany(Event, { foreignKey: "address_id" });
Event.belongsTo(Address, { foreignKey: "address_id" });
